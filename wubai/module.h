#ifndef __WUBAI_MODULE_H__
#define __WUBAI_MODULE_H__
...
public:
    ...
    virtual bool onConnect(wubai::Stream::ptr stream);
    virtual bool onDisConnect(wubai::Stream::ptr stream);

    virtual bool onServerReady();
    virtual bool onServerUp();

    virtual bool handleRequest(wubai::Message::ptr req, wubai::Message::ptr rsp, wubai::Stream::ptr stream);
    virtual bool handleNotify(wubai::Message::ptr notify, wubai::Stream::ptr stream);
...
typedef wubai::Singleton<ModuleManager> ModuleMgr;
