...
int32_t FunctionWSServlet::onConnect(wubai::http::HttpRequest::ptr header,
...
int32_t FunctionWSServlet::onClose(wubai::http::HttpRequest::ptr header,
                            wubai::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(wubai::http::HttpRequest::ptr header,
