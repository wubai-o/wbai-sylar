#ifndef __WUBAI_SOCKET_H__
#define __WUBAI_SOCKET_H__
...
public:
    ...
    static Socket::ptr CreateTCP(wubai::Address::ptr address);
    static Socket::ptr CreateUDP(wubai::Address::ptr address);
    ...
    bool setOption(int level, int option, const void* reuslt, size_t len);
